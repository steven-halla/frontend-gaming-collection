      ...
      <div className="wrapper">
        ...
        <div className="main-image-box">
          ...
          <div className="row">
            <div className="image-container">
              {/*<img src="https://i.pinimg.com/originals/0b/78/5a/0b785a4b2ff7d0e1c22dc1d59c30eb91.jpg"*/}
              {/*     alt="nintendo tapes"*/}
              {/*     width="400px"*/}
              {/*/>*/}
              <img
                src="https://www.2ndmarkets.com/images/video-game-1.jpg"
                alt=""
                width="400px"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="image-container">
              <img
                src="https://howchoo.com/media/y2/vm/zj/harvest-moon.jpeg?width=900&auto=webp&quality=80"
                alt=""
                width="400px"
              />
            </div>
        ...
        <div className="footer">
          ...
          <div className="contact-me-info-container">
            ...
            <p>Business hours: Monday-Friday 9-5 PST</p>
          </div>
        </div>
      </div>
    </StyledHome>
